    ...
    <div className="row">
      ...
      <div className="col-md-6">
        <div className="card">
          ...
          <div className="card-body">
            <div id="s-line" />
            <ReactApexChart options={sLineArea} series={sLineArea.series} type="line" height={350} />
          </div>
        </div>
      </div>
      {/* /Chart */}
      ...
      <div className="col-md-6">
        <div className="card">
          ...
          <div className="card-body">
            <div id="s-line-area" />
            <ReactApexChart options={sline} series={sline.series} type="area" height={350} />
          </div>
        </div>
      </div>
      {/* /Chart */}
      ...
      <div className="col-md-6">
        <div className="card">
          ...
          <div className="card-body">
            <div id="s-col" />
            <ReactApexChart options={sCol} series={sCol.series} type="bar" height={350} />
          </div>
        </div>
      </div>
      {/* /Chart */}
      ...
      <div className="col-md-6">
        <div className="card">
          ...
          <div className="card-body">
            ...
            <ReactApexChart options={sColStacked} series={sColStacked.series} type="bar" height={350} />
      ...
      <div className="col-md-6">
        <div className="card">
          ...
          <div className="card-body">
            <div id="donut-chart" />
            <ReactApexChart options={donutChart} series={ donutChart.series} type="donut" height={350} />
      ...
      <div className="col-md-6">
        <div className="card">
          ...
          <div className="card-body">
            ...
            <ReactApexChart options={radialChart} series={ radialChart.series} type="radialBar" height={350} />
