...
const RestuarentBilling = () => {
  return (
    <>
      <div className="main-wrapper restuarent">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="table-description">
                          {" "}
                          Finest Ramen<span>22 July 2022 at 2.30pm</span>
                        </td>
                      ...
                      <tr>
                        ...
                        <td className="table-description ">
                          {" "}
                          Sushi tray<span>22 July 2022 at 2.30pm</span>
                        </td>
                        <td className="text-center">$200</td>
                        <td className="text-center">1</td>
                        <td className="text-end">$200</td>
                      ...
                      <tr>
                        ...
                        <td className="table-description ">
                          {" "}
                          Extra Condiments<span>22 July 2022 at 2.30pm</span>
                        </td>
                        <td className="text-center">$200</td>
                        <td className="text-center">1</td>
                        <td className="text-end">$200</td>
...
export default RestuarentBilling;
