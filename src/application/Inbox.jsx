                ...
                <div className="col top-action-left">
                  <div className="float-left">
                    <div className="btn-group dropdown-action">
                      <button
                        type="button"
                        className="btn btn-white-outline dropdown-toggle me-1"
                ...
                <div className="col-auto top-action-right">
                  <div className="text-end">
                    <button
                      ...
                      title="Refresh"
                      data-toggle="tooltip"
                      className="btn btn-white-outline d-none d-md-inline-block me-1"
                    >
                      <i className="fas fa-sync-alt" />
                    </button>
                    <div className="btn-group">
                      <Link  className="btn btn-white-outline">
