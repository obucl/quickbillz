                  ...
                  <div className="col-lg-12">
                    <div className="invoices-tabs">
                      <ul>
                        ...
                        <li>
                          <Link to="/tickets-recurring"  className="active">Recurring</Link>
                        </li>
                        <li>
                          <Link to="/tickets-cancelled">Cancelled</Link>
                        </li>
                      </ul>
                    </div>
                  </div>
...
export default TicketListRecurring;
