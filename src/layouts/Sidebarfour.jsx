...
const Sidebarfour = (props) => {
  ...
  return (
    <div className="sidebar sidebar-three sidebar-four" id="sidebar">
      <Scrollbars
        autoHide
      ...
      >
        <div className="sidebar-inner slimscroll">
          <div id="sidebar-menu" className="sidebar-menu sidebar-menu-three">
            <Link id="aside" className="ui-aside">
              <ul className="tab nav nav-tabs" id="myTab" role="tablist">
                ...
                <li className="nav-item" role="presentation">
                  <Link
                    ...
                    aria-selected="false"
                  >
                    <FeatherIcon icon="file" className="feather-file" />
                  </Link>
                </li>
                <li className="nav-item" role="presentation">
                  <Link className="tablinks nav-link" to="/chat">
                    <FeatherIcon icon="message-square" className="feather-message" />
                  </Link>
                </li>
                <li className="nav-item" role="presentation">
                  <Link className="tablinks nav-link" to="/inbox">
                    <FeatherIcon icon="mail" className="feather-mails"/>
                  </Link>
                </li>
                <li className="nav-item" role="presentation">
            ...
            <div className="tab-content tab-content-three">
              <ul
              ...
              >
                ...
                >
                  ...
                  >
                    <FeatherIcon icon="grid" /> <span> Applications</span>{" "}
                ...
                >
                  <Link to="/customers">
                    <FeatherIcon icon="users" className="me-1"/>
                    <span>Customers</span>
                  </Link>
                </li>
                <li
              ...
              <ul className="tab-pane" id="profile" aria-labelledby="profile-tab">
                <li className="menu-title menu-title-three"></li>
                <li
                className={`${
                  "/profile" === pathName
                    ? "active"
