                ...
                <div className="content container-fluid">
						...
						<div className="content-page-header">						
							...
							<div className="list-btn">
								<ul className="filter-list">
									<li>
										<Link to="#" onClick = {() => setshowmodel ("showEvents")} className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_event">Create Event</Link>
									</li>
								</ul>
							</div>
						</div>
					...
					<div className="row">
                        ...
                        <div className='card-body'>
                            ...
                            <Link to="#0" onClick = {() => setshowmodel("showCategory")} className="btn mb-3 btn-primary btn-block w-100 w-100">
