...
(function ($) {
  ...
  function init() {
    ...
    var sidebar_four = localStorage.getItem("sidebar-4");

    if (sidebar_four) {
      $(sidebar_four).addClass("active");
      if (sidebar_four == "#home-tab") $("#home").addClass("active");
      if (sidebar_four == "#messages-tab") $("#messages").addClass("active");
      if (sidebar_four == "#profile-tab") $("#profile").addClass("active");
    } else {
  ...
  $("#home-tab").click(function () {
    $("#home-tab").addClass("active");
    $("#home").addClass("active");
    localStorage.setItem("sidebar-4", "#home-tab");
  });
  ...
  $("#messages-tab").click(function () {
    ...
    localStorage.setItem("sidebar-4", "#messages-tab");
  });

  $("#profile-tab").click(function () {
    $("#profile-tab").addClass("active");
    $("#profile").addClass("active");
    localStorage.setItem("sidebar-4", "#profile-tab");
  });
