                  ...
                  <div className="col-lg-12">
                    <div className="invoices-tabs">
                      <ul>
                        ...
                        <li>
                          <Link to="/inactive-blog" className="active">Inactive Blog</Link>
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="blog-content">
                    ...
                    <div className="edit-options">
                      <div className="edit-delete-btn">
                        ...
                        >
                          <FeatherIcon icon="trash-2" className="me-1" />
                          Delete
                        </Link>
                      </div>
                      <div className="text-end inactive-style">
                        ...
                        >
                          <FeatherIcon icon="alert-circle" className="me-1" />
                          Active
                        </Link>
                      </div>
                    </div>
