...
import { De, Es, Fr, img2, img3, img4, img7, LogoImg, LogoSmallImg, logowhite, search, Us, Us1 } from "../_components/imagepath";
...
const Headertwo = (props) => {
  ...
  <Link className="mobile_btn" id="mobile_btn" onClick={handlesidebar}>
