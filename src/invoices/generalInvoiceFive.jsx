...
import { InvoiceLogoWhite } from "../_components/imagepath";
import { InvoiceLogoDark } from "../_components/imagepath";
import { Link } from "react-router-dom";

const GeneralInvoiceFive = () => {
    ...
    <div className="main-wrapper index-five">
      <div className="container">
        ...
        <div className="file-link">
          ...
          <FeatherIcon icon="download-cloud" className="me-1"/> <span>Download</span>
          </button>
