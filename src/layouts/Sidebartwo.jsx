        ...
        <div className="sidebar-inner slimscroll">
          <div id="sidebar-menu" className="sidebar-menu sidebar-menu-two">
            ...
            <ul>
              ...
              <li className={`${"/debit-notes" === pathName ? "active" : ""}`}>
                <Link to="/debit-notes">
            ...
            <ul>
              ...
              <li
                className={`${
                  "/roles-permission" === pathName || "/permission" === pathName
                    ? "active"
                    : ""
                }`}
              >
            ...
            <ul>
              ...
              >
                <Link
                  ...
                  onClick={() =>
                    toggleSidebar(
                      isSideMenu == "membership-plans" ? "" : "membership-plans"
                    )
                  }
                >
              ...
              >
                ...
                {isSideMenu == "add-page" ? (
                  ...
                  >
                    ...
                    <li className={`${"/pages" === pathName ? "active" : ""}`}>
              ...
              >
                ...
                {isSideMenu == "all-blogs" ? (
                  ...
                  >
                    ...
                    <li
                      className={`${"/add-blog" === pathName ? "active" : ""}`}
                    >
              ...
              >
                ...
                {isSideMenu == "countries" ? (
                  ...
                  >
                    ...
                    <li className={`${"/states" === pathName ? "active" : ""}`}>
                      <Link to="/states">States</Link>
                    </li>
                    <li className={`${"/cities" === pathName ? "active" : ""}`}>
            ...
            <ul>
              ...
              <li className={`${"/error-400" === pathName ? "active" : ""}`}>
                <Link to="/error-400">
              ...
              <li className={`${"/vector-map" === pathName ? "active" : ""}`}>
                <Link to="/vector-map">
            ...
            <ul>
              ...
              >
                ...
                {isSideMenu == "alerts" ? (
                  ...
                  >
                    <li className={`${"/alerts" === pathName ? "active" : ""}`}>
                    ...
                    <li className={`${"/avatar" === pathName ? "active" : ""}`}>
                      <Link to="/avatar">Avatar</Link>
                    </li>
                    <li className={`${"/badges" === pathName ? "active" : ""}`}>
                    ...
                    <li className={`${"/cards" === pathName ? "active" : ""}`}>
                      <Link to="/cards">Cards</Link>
                    </li>
                    <li
                      className={`${"/carousel" === pathName ? "active" : ""}`}
                    >
                      <Link to="/carousel">Carousel</Link>
                    </li>
                    <li
                      className={`${"/dropdowns" === pathName ? "active" : ""}`}
                    >
                    ...
                    <li className={`${"/images" === pathName ? "active" : ""}`}>
                      <Link to="/images">Images</Link>
                    </li>
                    <li
                      className={`${"/lightbox" === pathName ? "active" : ""}`}
                    >
                      <Link to="/lightbox">Lightbox</Link>
                    </li>
                    <li className={`${"/media" === pathName ? "active" : ""}`}>
                      <Link to="/media">Media</Link>
                    </li>
                    <li className={`${"/modals" === pathName ? "active" : ""}`}>
                      <Link to="/modals">Modals</Link>
                    </li>
                    <li
                      className={`${"/offcanvas" === pathName ? "active" : ""}`}
                    >
                    ...
                    <li className={`${"/toasts" === pathName ? "active" : ""}`}>
                    ...
                    <li className={`${"/video" === pathName ? "active" : ""}`}>
              ...
              >
                ...
                {isSideMenu == "ribbon" ? (
                  ...
                  >
                    <li className={`${"/ribbon" === pathName ? "active" : ""}`}>
                      <Link to="/ribbon">Ribbon</Link>
                    </li>
                    <li
                      className={`${"/clipboard" === pathName ? "active" : ""}`}
                    >
                      <Link to="/clipboard">Clipboard</Link>
                    </li>
                    <li
                      className={`${"/drag-drop" === pathName ? "active" : ""}`}
                    >
                      <Link to="/drag-drop">Drag & Drop</Link>
                    </li>
                    <li className={`${"/rating" === pathName ? "active" : ""}`}>
                    ...
                    <li
                      className={`${"/scrollbar" === pathName ? "active" : ""}`}
                    >
                    ...
                    <li
                      className={`${"/timeline" === pathName ? "active" : ""}`}
                    >
              ...
              >
                ...
                {isSideMenu == "apex-charts" ? (
                  ...
                  >
                    ...
                    <li
                      className={`${"/chart-js" === pathName ? "active" : ""}`}
                    >
                    ...
                    <li
                      className={`${"/c3-charts" === pathName ? "active" : ""}`}
                    >
              ...
              >
                ...
                {isSideMenu == "fontawesome-icons" ? (
                  ...
                  >
                    ...
                    <li
                      className={`${"/pe7-icons" === pathName ? "active" : ""}`}
                    >
            ...
            <ul>
              ...
              <li className={`${"/logout" === pathName ? "active" : ""}`}>
                <Link to="/logout">
