								...
								<div className="card-body">
									<form action="#">
										...
										<div className="form-group row">
											...
											<div className="col-lg-9">
												<input type="password" autoComplete="off" className="form-control" onChange={formHandler} />
											</div>
										</div>
										<div className="form-group row">
										...
										<div className="row">
											<div className="col-xl-6">
												...
												<div className="form-group row">
													...
													<div className="col-lg-9">
                                                        <Select2 className="w-100" data={bgOptions}  options={{ placeholder: 'Blood group',}}/>                                                          
													</div>
												</div>
											</div>
											<div className="col-xl-6">
												...
												<div className="form-group row">
													<label className="col-lg-3 col-form-label">Password</label>
													<div className="col-lg-9">
														<input type="password" className="form-control" autoComplete="off"  onChange={formHandler} />
													</div>
												</div>
												<div className="form-group row">
													<label className="col-lg-3 col-form-label">Repeat Password</label>
										...
										<div className="row">
											<div className="col-xl-6">
												...
												<div className="form-group row">
													<label className="col-lg-3 col-form-label">State</label>
													<div className="col-lg-9">
                                                    	<Select2 className="w-100" data={stateOptions}  options={{ placeholder: 'Select State',}}/>                                                        
													</div>
												</div>
												<div className="form-group row">
												...
												<div className="form-group row">
													...
													<div className="row">
														<div className="form-group col-md-6">
															<label>Country</label>
															<Select2 className="w-100" data={countryOptions} options={{placeholder: 'Select Country',}}/>																													
														</div>
														<div className="form-group col-md-6">
